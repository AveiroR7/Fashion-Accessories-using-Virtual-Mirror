...
public class Overlay {
	...
	public static IplImage getOverlaidFrame(IplImage grabbedFrame,
		...
		if (optionsEnabled == true) {
			...
			// zoom in
			//g2.drawOval((int) (0.11 * x_scale), 0, (int) (0.16 * x_scale),(int) (0.16 * x_scale));
			// g2.drawRect((int) (0.12 * x_scale), (int) (0.02 * y_scale),
			// (int) (0.14 * x_scale), (int) (0.18 * y_scale));
			// zoom out
			//g2.drawOval(0, (int) (0.25 * y_scale), (int) (0.16 * x_scale),(int) (0.16 * x_scale));
			// g2.drawRect((int) (0.01 * x_scale), (int) (0.27 * y_scale),
			// (int) (0.14 * x_scale), (int) (0.18 * y_scale));

			// up
			//g2.drawOval((int) (0.73 * x_scale), 0, (int) (0.16 * x_scale),(int) (0.16 * x_scale));
			// g2.drawRect((int) (0.74 * x_scale), (int) (0.02 * y_scale),
			// (int) (0.14 * x_scale), (int) (0.18 * y_scale));
			// down
			//g2.drawOval((int) (0.84 * x_scale), (int) (0.25 * y_scale),(int) (0.16 * x_scale), (int) (0.16 * x_scale));
			// g2.drawRect((int) (0.85 * x_scale), (int) (0.27 * y_scale),
			// (int) (0.14 * x_scale), (int) (0.18 * y_scale));

			// previous
			//g2.drawRect((int) (0.01 * x_scale), (int) (0.67 * y_scale),(int) (0.18 * x_scale), (int) (0.12 * y_scale));
			// next
			//g2.drawRect((int) (0.81 * x_scale), (int) (0.67 * y_scale),(int) (0.18 * x_scale), (int) (0.12 * y_scale));

			g2.setPaint(new Color(255, 255, 0, 64));

			// zoom in
			//g2.fillOval((int) (0.11 * x_scale), 0, (int) (0.16 * x_scale),(int) (0.16 * x_scale));
			// zoom out
			//g2.fillOval(0, (int) (0.25 * y_scale), (int) (0.16 * x_scale),(int) (0.16 * x_scale));

			// up
			//g2.fillOval((int) (0.73 * x_scale), 0, (int) (0.16 * x_scale),(int) (0.16 * x_scale));
			// down
			//g2.fillOval((int) (0.84 * x_scale), (int) (0.25 * y_scale),(int) (0.16 * x_scale), (int) (0.16 * x_scale));

			// previous
			//g2.fillRect((int) (0.01 * x_scale), (int) (0.67 * y_scale),(int) (0.18 * x_scale), (int) (0.12 * y_scale));
			// next
			//g2.fillRect((int) (0.81 * x_scale), (int) (0.67 * y_scale),(int) (0.18 * x_scale), (int) (0.12 * y_scale));
