...
import static com.googlecode.javacv.cpp.opencv_imgproc.cvSmooth;
import static com.googlecode.javacv.cpp.opencv_imgproc.cvThreshold;
import com.virtual.view.Overlay;
...
public class Category {
	...
	private static int waitDelay;
        private static JButton male;
        private static JButton female;
					...
					if (contour.elem_size() > 0) {
						...
						if (box != null) {
							...
							if (posX >= (int) (0.02 * x_scale)
								...
								/*com.virtual.VTR.CategoryNumber = 1;
								com.virtual.VTR.overlayImagePath = "overlays/M/0.png";*/
							}
							...
							if (posX >= (int) (0.02 * x_scale)
								...
								/*com.virtual.VTR.CategoryNumber = 2;
								com.virtual.VTR.overlayImagePath = "overlays/F/0.png";*/
							}
							...
							if (posX >= (int) (0.02 * x_scale)
								...
								/*com.virtual.VTR.CategoryNumber = 3;
								com.virtual.VTR.overlayImagePath = "overlays/K/0.png";*/
							}
							...
							if (posX >= (int) (0.8 * x_scale)
									...
									/*&& com.virtual.VTR.CategoryNumber != 0*/) {

								pageNum = 1;
								//com.virtual.VTR.startOptions = false;
