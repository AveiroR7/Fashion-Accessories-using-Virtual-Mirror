...
public class OptionsPanel {
	...
	public static JPanel getPanel() {
		...
		down.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				com.virtual.view.Overlay.horizontalDilsplacement += 5;
			}
		});
		...
		nextOverlay.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent arg0) {
				com.virtual.view.Overlay.SCALE = 0.25;
				imageNumber = (imageNumber + 1) % 23;
				//com.virtual.view.VTR.overlayImagePath = "overlays/" + imageNumber + ".png";
			}
	...
	protected static void takeSnapshot() {
		// TODO Auto-generated method stub
		try {
			final BufferedImage img = com.virtual.view.Overlay.snap.getBufferedImage();
			...
			buttonSave.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent arg0) {
					...
					com.virtual.view.Overlay.snapshotEnabled = true;
				}
			});
	...
	protected static void zoomOut() {
		if (com.virtual.view.Overlay.SCALE > 0.15) {
			// TODO Auto-generated method stub
			com.virtual.view.Overlay.SCALE -= .0125;
		}
	}

	protected static void zoomIn() {
		if (com.virtual.view.Overlay.SCALE < 0.50) {
			// TODO Auto-generated method stub
			com.virtual.view.Overlay.SCALE += .0125;
		}
	}
