...
public class SnapImage {
	...
	static opencv_core.IplImage currentFrame = null;
	static opencv_core.IplImage prevFrame = null;
	static opencv_core.IplImage diffFrame = null;
	private static boolean flag = true;
	private static int waitDelay = 0;

	public static opencv_core.IplImage getOverlaidFrame(opencv_core.IplImage grabbedFrame)
			throws IOException {
		...
		g2.dispose();
		g2D.dispose();
		grabbedFrame = opencv_core.IplImage.createFrom(overlaidImage);
		g.dispose();
